"""
nuke_snowflake_data.py
Drops all tables in the specified Snowflake schema.
"""
import os
import urllib.parse
...
TABLES = [
    ...
    "APP_META", "NEWS_REPORTS", "STRIPE_TRANSACTIONS" # including some from diagnostic
]

print(f"⚠️ NUKING DATABASE: {SF_DB}.{SF_SCHEMA} ⚠️")
...
print("\n✅ All datasets removed from Snowflake.")
